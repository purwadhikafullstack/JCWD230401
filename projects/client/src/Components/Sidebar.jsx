            ...
            <Flex w="100%" alignItems={"center"}>
                ...
                >
                    <Box onClick={() => navigate("/dashboard")}>
                        <Button
                            leftIcon={<AiOutlineLineChart size={20} />}
                            variant="none"
                            size="md"
                        >
                            <Text
                    ...
                    <Box h="40px" onClick={() => navigate("/properties")}>
                        <Flex>
                            <Button
                                leftIcon={<BiBuildingHouse size={20} />}
                                variant="none"
                                size="md"
                                ml={{ base: "2", lg: "0" }}
                            ></Button>
                    ...
                    <Box h="40px" onClick={() => navigate("/statistics")}>
                        <Button
                            leftIcon={<BiPieChartAlt2 size={20} />}
                            variant="none"
                            size="md"
                        >
                            <Text
